...
export const demoProducts: IProduct[] = [
  demo({
    ...
    images: [img(IMG.a), img(IMG.b), img(IMG.f), img(IMG.h), img(IMG.m)],
  ...
  demo({
    ...
    images: [img(IMG.b), img(IMG.a), img(IMG.g), img(IMG.i), img(IMG.n)],
  ...
  demo({
    ...
    images: [img(IMG.c), img(IMG.e), img(IMG.f), img(IMG.k), img(IMG.h)],
  ...
  demo({
    ...
    images: [img(IMG.d), img(IMG.a), img(IMG.b), img(IMG.j), img(IMG.m)],
  ...
  demo({
    ...
    images: [img(IMG.e), img(IMG.c), img(IMG.g), img(IMG.n), img(IMG.k)],
  ...
  demo({
    ...
    images: [img(IMG.f), img(IMG.h), img(IMG.e), img(IMG.n), img(IMG.l)],
  ...
  demo({
    ...
    images: [img(IMG.g), img(IMG.a), img(IMG.i), img(IMG.m), img(IMG.f)],
  ...
  demo({
    ...
    images: [img(IMG.c), img(IMG.k), img(IMG.g), img(IMG.j), img(IMG.e)],
  ...
  demo({
    ...
    images: [img(IMG.b), img(IMG.d), img(IMG.f), img(IMG.i), img(IMG.n)],
  ...
  demo({
    ...
    images: [img(IMG.a), img(IMG.d), img(IMG.j), img(IMG.h), img(IMG.l)],
  ...
  demo({
    ...
    images: [img(IMG.i), img(IMG.e), img(IMG.c), img(IMG.k), img(IMG.n)],
  ...
  demo({
    ...
    images: [img(IMG.h), img(IMG.f), img(IMG.e), img(IMG.l), img(IMG.m)],
